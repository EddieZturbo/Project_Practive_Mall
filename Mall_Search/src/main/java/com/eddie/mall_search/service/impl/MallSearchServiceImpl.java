...
import com.eddie.mall_search.feign.GoodsOpenFeign;
import com.eddie.mall_search.service.MallSearchService;
import com.eddie.mall_search.vo.AttrResponseVo;
    ...
    private SearchResult buildSearchResult(SearchResponse response, SearchParam param) {
        ...
        if (param.getAttrs() != null && param.getAttrs().size() > 0) {
            List<SearchResult.NavVo> collect = param.getAttrs().stream().map(attr -> {
                ...
                R r = goodsOpenFeign.info(Long.parseLong(s[0]));
                if (r.getCode() == 0) {
                ...
                navVo.setLink("http://http://search.zhangjinhao.com/list.html?" + replace);
